...
import { Trophy, Instagram, Youtube, Linkedin, Music2 } from 'lucide-react';
          ...
          <div className="col-span-1 lg:col-span-1">
            ...
            <div className="flex gap-4">
              {[Instagram, Youtube, Linkedin, Music2].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center hover:bg-tennis-neon hover:text-midnight transition-all">
